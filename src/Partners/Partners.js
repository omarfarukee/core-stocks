...
const Partners = () => {
    ...
    return (
        <div>
             <div>
            <div className='flex justify-center text-3xl font-bold'><h1>Create shares Account</h1></div>
 ...
 <Link to='/companyAccount'> <button className='btn btn-primary'>go Shares account</button></Link> 
            </form>
