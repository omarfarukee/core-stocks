        ...
        <div>
            ...
            <form onSubmit={handleSubmit(handleAddReturnProduct)}>
                ...
                <div className='lg:grid lg:grid-cols-2 md:grid md:grid-cols-2 bg-gray-300 p-5 rounded-2xl ml-3'>
                    ...
                    <div className="form-control w-full max-w-xs">
                        <label className="label"> <span className="label-text">Return from</span></label>
                        <input type="text" {...register("returnFrom", {
                            required: "Required"
                        })} className="input input-bordered w-full max-w-xs" />
                        {errors.returnFrom && <p className='text-red-500'>{errors.returnFrom.message}</p>}
                    </div>

                    <div className="form-control w-full max-w-xs">
                        <label className="label"> <span className="label-text">Return Date 'dd/mm/yyyy'</span></label>
                        <input type="text" {...register("returnDate", {
                            required: "Required"
                        })} className="input input-bordered w-full max-w-xs" />
...
export default AddReturnStokes;